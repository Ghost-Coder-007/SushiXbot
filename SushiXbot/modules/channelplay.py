...
from SushiXbot.modules.play import generate_cover
from SushiXbot.modules.play import arq
from SushiXbot.modules.play import cb_admin_check
from SushiXbot.modules.play import transcode
from SushiXbot.modules.play import convert_seconds
from SushiXbot.modules.play import time_to_seconds
from SushiXbot.modules.play import changeImageSize
from SushiXbot.config import BOT_NAME as bn
from SushiXbot.config import DURATION_LIMIT
from SushiXbot.config import UPDATES_CHANNEL as updateschannel
from SushiXbot.config import que
from SushiXbot.function.admins import admins as a
from SushiXbot.helpers.errors import DurationLimitError
from SushiXbot.helpers.decorators import errors
from SushiXbot.helpers.admins import get_administrators
from SushiXbot.helpers.channelmusic import get_chat_id
from SushiXbot.helpers.decorators import authorized_users_only
from SushiXbot.helpers.filters import command
from SushiXbot.helpers.filters import other_filters
from SushiXbot.helpers.gets import get_file_name
from SushiXbot.services.callsmusic import callsmusic
from SushiXbot.services.callsmusic import client as USER
from SushiXbot.services.converter.converter import convert
from SushiXbot.services.downloaders import youtube
from SushiXbot.services.queues import queues
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @SushiXbot to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
